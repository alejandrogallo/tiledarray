...
BOOST_AUTO_TEST_CASE(indexMap) {
  ...
  std::vector<indexMap_test_tuple> indexMap_tests {
    ...
    {
        IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay"}),
        IndexMap<Index, std::string>("a,b,c", {"aye", "bee", "see"}),
        IndexMap<Index, std::string>("i,b,c,j,k,a", {"eye", "bee", "see", "jay", "kay", "aye"})
    },
    {
        IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay"}),
        IndexMap<Index, std::string>("", {}),
        IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay" })
    },
    {
        IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay"}),
  ...
  //For testing IndexMaps that should not be equal
/*  struct indexMap_neq_test_tuple {
    IndexMap<Index, std::string> lhs;
    IndexMap<Index, std::string> rhs;
  };
  std::vector<indexMap_neq_test_tuple> indexMap_neq_tests {
    {
      IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay"}),
      IndexMap<Index, std::string>("i,j,k", {"eye", "kay", "jay"})
    },
    {
      IndexMap<Index, std::string>("i,j,k", {"eye", "jay", "kay"}),
        IndexMap<Index, std::string>("i,j,l", {"eye", "jay", "kay"})
    }
  };
  for (const auto test : indexMap_tests) {
    IndexMap lhs(test.lhs);
